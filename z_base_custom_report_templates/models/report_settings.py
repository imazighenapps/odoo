...
class TemplateSettings(models.Model):
    ...
    text_color = fields.Char(
        ...
        default="#6B6C6C",
        help=
        "The Text color of the invoice. Normally this should be one of your official \
    ...
    name_color = fields.Char(
        ...
        default="#F07C4D",
        help=
        "The Text color of the Company Name. Normally this should be one of your official\
                        company colors or default HTML text color")
    cust_color = fields.Char(
        ...
        default="#F07C4D",
        help=
        "The Text color of the Customer Name. Normally this should be one of your official\
                        company colors or default HTML text color")
    theme_txt_color = fields.Char(
        ...
        default="#FFFFFF",
        help=
        "The Text color of the areas bearing the theme color. Normally this should NOT\
                        be the same color as the theme color. Otherwise the text will not be visible"
    )

    header_font = fields.Selection([(str(x), str(x)) for x in range(1, 51)],
                                   string="Header Font(px):",
                                   default='10',
                                   required=True)
    body_font = fields.Selection([(str(x), str(x)) for x in range(1, 51)],
                                 string="Body Font(px):",
                                 default='10',
                                 required=True)
    footer_font = fields.Selection([(str(x), str(x)) for x in range(1, 51)],
    ...
    show_img = fields.Boolean(
        ...
        default=True,
        help=
        "Check this box to display product image in Sales Order, Quotation, \
    ...
    transparent = fields.Boolean(
        ...
        default=False,
        help=
        "Check this box to have a transparent background for your reports. \n\
    ...
    footer = fields.Boolean(
        ...
        default=True,
        help=
        "Check this box to enable footer in your reports. \nYou may want to disable footer \
...
''',
    ...
    wm_color = fields.Char('Watermark color',
                           size=7,
                           default="#5A5B5C",
                           required=True,
